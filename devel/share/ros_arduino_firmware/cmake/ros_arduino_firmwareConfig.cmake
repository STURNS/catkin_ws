...
if("TRUE" STREQUAL "TRUE")
  set(ros_arduino_firmware_SOURCE_PREFIX /home/ly/catkin_ws/src/ros_arduino_bridge/ros_arduino_firmware)
  set(ros_arduino_firmware_DEVEL_PREFIX /home/ly/catkin_ws/devel)
  ...
  set(ros_arduino_firmware_INSTALL_PREFIX /home/ly/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ros_arduino_firmware' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Patrick Goebel <patrick@pirobot.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ros_arduino_firmware' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ly/catkin_ws/src/ros_arduino_bridge/ros_arduino_firmware/${idir}'.  Ask the maintainer 'Patrick Goebel <patrick@pirobot.org>' to fix it.")
    endif()
